...
public class Starter {
    ...
    public static void main(String[] args) {
        try{
            ...
            asc4.setTrasmettitore((TrasmettitoreProxy)ProxyTarget.createProxy(new TrasmettitoreREST("http://localhost:17781/WS/REST")));
            HashMap conf4 = new HashMap();
            conf4.put("portaAscoltoEsterna", 17781);
            conf4.put("portaAscoltoInterna", 17782);        
            asc4.ricevitori.add((RicevitoreProxy)ProxyTarget.createProxy(new RicevitoreSOAP(conf4)));
            ...
            asc3.setTrasmettitore((TrasmettitoreProxy)ProxyTarget.createProxy(new TrasmettitoreSocket(new Socket("localhost",17781))));
            HashMap conf3 = new HashMap();
            conf3.put("portaAscoltoEsterna", 17778);
            conf3.put("portaAscoltoInterna", 17779);           
            asc3.ricevitori.add((RicevitoreProxy)ProxyTarget.createProxy(new RicevitoreSocket(conf3)));
            HashMap conf3a = new HashMap();
            conf3a.put("portaAscoltoEsterna", 17780);
            conf3a.put("portaAscoltoInterna", 17779);
            asc3.ricevitori.add((RicevitoreProxy)ProxyTarget.createProxy(new RicevitoreSOAP(conf3a)));
            ...
            asc2.ricevitori.add((RicevitoreProxy)ProxyTarget.createProxy(new RicevitoreSocket(conf2)));
            ...
            asc1.setTrasmettitore((TrasmettitoreProxy)ProxyTarget.createProxy(new TrasmettitoreSocket(new Socket("localhost",17776))));
            HashMap conf1 = new HashMap();
            conf1.put("portaAscoltoEsterna", 17774);
            conf1.put("portaAscoltoInterna", 17775);
            asc1.ricevitori.add((RicevitoreProxy)ProxyTarget.createProxy(new RicevitoreSocket(conf1)));
            HashMap conf1a = new HashMap();
            conf1a.put("portaAscoltoEsterna", 17773);
            conf1a.put("portaAscoltoInterna", 17775);
            asc1.ricevitori.add((RicevitoreProxy)ProxyTarget.createProxy(new RicevitoreSOAP(conf1a)));
