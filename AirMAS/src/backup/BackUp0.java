...
public class BackUp0 {
     ...
     public static void main(String[] args) throws Exception {
         try {
            ...
            asc1.getConf().put("socketUscita","localhost:60010");
            asc1.getConf().put("socketIngresso","60001");
            ...
            asc2.getConf().put("socketUscita","localhost:60020");
            asc2.getConf().put("socketIngresso","60002");
